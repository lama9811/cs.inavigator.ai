  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "presentation_details", label: "Presentation details", type: "text", hint: "Type, title, conference, location, and date for each.", requiredWhen: { field: "did_present_research_this_year", value: "Yes" } },
        ...
        { id: "relevance_to_education", label: "Relevance of Experience to Your Education", type: "text", requiredWhen: { field: "participated_in_experience", value: "Yes" } },
        ...
        { id: "second_relevance_to_education", label: "Relevance of Experience to Your Education (2)", type: "text", requiredWhen: { field: "had_second_experience", value: "Yes" } },
