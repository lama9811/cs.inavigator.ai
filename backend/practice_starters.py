...
PRACTICE_ARG_SPECS: dict[str, tuple[list[tuple[str, str]], str]] = {
    ...
    "allWordsWithPrefix": ([("words", "strlist"), ("prefix", "string")], "bool"),
    "bestNonAdjacentTotal": ([("points", "intlist")], "int"),
    "blockedStairWays": ([("openSteps", "intlist")], "int"),
    ...
    "coinChangeWaysSmall": ([("coins", "intlist"), ("amount", "int")], "int"),
    ...
    "firstWordWithPrefix": ([("words", "strlist"), ("prefix", "string")], "string"),
    "hasRepeatedGroupLink": ([("n", "int"), ("pairs", "grid")], "bool"),
    "uniqueParkingZones": ([("zones", "strlist")], "int"),
    "largestGroupAfterLinks": ([("n", "int"), ("pairs", "grid")], "int"),
    "mainDiagonalValues": ([("matrix", "grid")], "intlist"),
    "membersConnectedToZero": ([("n", "int"), ("pairs", "grid")], "intlist"),
    ...
    "neighborCount": ([("edges", "strgrid"), ("node", "string")], "int"),
    "prefixSumAt": ([("nums", "intlist"), ("index", "int")], "int"),
    "rangeSumOneQuery": ([("nums", "intlist"), ("left", "int"), ("right", "int")], "int"),
    ...
    "turnOffLowestBit": ([("n", "int")], "int"),
    "waysOneThreeSteps": ([("n", "int")], "int"),
}
